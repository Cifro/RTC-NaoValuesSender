...
# IP address and port of CORBA server
IP = "127.0.0.1:2809"
...
def main():
  ...
  # get NamingService
  naming = OpenRTM_aist.CorbaNaming(orb, IP)

  conin = OpenRTM_aist.CorbaConsumer()
  conout = OpenRTM_aist.CorbaConsumer()

  # find NaoValuesSender0 component
  conin.setObject(naming.resolve("NaoValuesSender0.rtc"))
